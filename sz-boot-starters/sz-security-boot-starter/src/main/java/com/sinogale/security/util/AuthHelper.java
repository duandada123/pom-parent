...
public class AuthHelper {
    ...
    public static String getLoginRedisKey(BaseJwtUser user) {
        ...
        builder.append("token:").append(user.getPlatform().getCode()).append(":").append(user.getUserType().getCode()).append(":").append(user.getUserId());
        return builder.toString();
    }

    public static String getLoginSucRedisKey(TokenInfo tokenInfo) {
        StringBuilder builder = new StringBuilder();
        builder.append("token:").append(tokenInfo.getPlatform().getCode()).append(":").append(tokenInfo.getUserType().getCode()).append(":").append(tokenInfo.getUserId());
        return builder.toString();
    }
}
